...
mongoose
  ...
  .then(async () => {
    ...
    let presTrainingData = [
      ...
      {
        message: "How MANY friends",
        level: "count",
      },
      {
        message: "How Many cars",
        level: "count",
      },
      {
        message: "How Many attendees",
        level: "count",
      },
      {
        message: "HOW MANY speakers",
        level: "count",
      },
      {
    ...
    app.get("/save-to-sheets", async (req, res) => {
      try {
        ...
        let results = await Tests.findOne({
          layer: "processing",
          classifier: "bayes",
        });
        ...
        sheet = await doc.addSheet({
          title: "Logistics Regression Processing",
          headerValues: [
            "trainingSet",
            "testSet",
            "passed",
    ...
    app.post("/login", async (req, res) => {
      ...
      let hashedPassword = await crypto
        .createHash("sha256")
      ...
      return res.status(200).json({
        ...
        token: crypto
          .createHash("sha256")
          .update(account._id.toString(), "utf8")
          .digest("hex"),
        account,
      });
    });
